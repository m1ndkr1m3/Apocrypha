...
2. getFunctionPtr(dll_name, function_name) which dynamically resolves function addresses takes djb2 hashes of the strings for the module name (unicode string) and function name (ASCII string). You can use djb2.py to generate djb2 hashes for this.
